...
class EmailSendingApi
{
     ...
     *
     * @param  \sendx\model\XEmailMessage $x_email_message x_email_message (required)
     ...
     * @return \sendx\model\XEmailResponse[]|\sendx\model\ErrorResponse|\sendx\model\ErrorResponse|\sendx\model\ErrorResponse|\sendx\model\ErrorResponse
     */
    public function sendEmail($x_email_message, string $contentType = self::contentTypes['sendEmail'][0])
    {
        list($response) = $this->sendEmailWithHttpInfo($x_email_message, $contentType);
        return $response;
    }
     ...
     * Send transactional email
     *
     * @param  \sendx\model\XEmailMessage $x_email_message (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sendEmail'] to see the possible values for this operation
     *
     * @throws \sendx\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \sendx\model\XEmailResponse[]|\sendx\model\ErrorResponse|\sendx\model\ErrorResponse|\sendx\model\ErrorResponse|\sendx\model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendEmailWithHttpInfo($x_email_message, string $contentType = self::contentTypes['sendEmail'][0])
    {
        $request = $this->sendEmailRequest($x_email_message, $contentType);
     ...
     */
    public function sendEmailAsync($x_email_message, string $contentType = self::contentTypes['sendEmail'][0])
    {
        return $this->sendEmailAsyncWithHttpInfo($x_email_message, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendEmailAsyncWithHttpInfo($x_email_message, string $contentType = self::contentTypes['sendEmail'][0])
    {
        $returnType = '\sendx\model\XEmailResponse[]';
        $request = $this->sendEmailRequest($x_email_message, $contentType);
     ...
     */
    public function sendEmailRequest($x_email_message, string $contentType = self::contentTypes['sendEmail'][0])
    {

        // verify the required parameter 'x_email_message' is set
        if ($x_email_message === null || (is_array($x_email_message) && count($x_email_message) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_email_message when calling sendEmail'
            );
        }
        ...
        // for model (json/xml)
        if (isset($x_email_message)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($x_email_message));
            } else {
                $httpBody = $x_email_message;
            }
     ...
     * @return \sendx\model\XEmailResponse[]|\sendx\model\ErrorResponse|\sendx\model\ErrorResponse|\sendx\model\ErrorResponse|\sendx\model\ErrorResponse
     */
    public function sendEmailWithTemplate($x_email_message, string $contentType = self::contentTypes['sendEmailWithTemplate'][0])
    {
        list($response) = $this->sendEmailWithTemplateWithHttpInfo($x_email_message, $contentType);
        return $response;
    }
     ...
     * @return array of \sendx\model\XEmailResponse[]|\sendx\model\ErrorResponse|\sendx\model\ErrorResponse|\sendx\model\ErrorResponse|\sendx\model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendEmailWithTemplateWithHttpInfo($x_email_message, string $contentType = self::contentTypes['sendEmailWithTemplate'][0])
    {
        $request = $this->sendEmailWithTemplateRequest($x_email_message, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendEmailWithTemplateAsync($x_email_message, string $contentType = self::contentTypes['sendEmailWithTemplate'][0])
    {
        return $this->sendEmailWithTemplateAsyncWithHttpInfo($x_email_message, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendEmailWithTemplateAsyncWithHttpInfo($x_email_message, string $contentType = self::contentTypes['sendEmailWithTemplate'][0])
    {
        $returnType = '\sendx\model\XEmailResponse[]';
        $request = $this->sendEmailWithTemplateRequest($x_email_message, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendEmailWithTemplateRequest($x_email_message, string $contentType = self::contentTypes['sendEmailWithTemplate'][0])
    {

        // verify the required parameter 'x_email_message' is set
        if ($x_email_message === null || (is_array($x_email_message) && count($x_email_message) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_email_message when calling sendEmailWithTemplate'
            );
        }


        $resourcePath = '/send/template';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
