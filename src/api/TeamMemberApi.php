...
class TeamMemberApi
{
     ...
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAllTeamMembers'] to see the possible values for this operation
     *
     * @throws \sendx\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendx\model\RestRMember[]|\sendx\model\ErrorResponse|\sendx\model\ErrorResponse
     */
    public function getAllTeamMembers(string $contentType = self::contentTypes['getAllTeamMembers'][0])
    {
        list($response) = $this->getAllTeamMembersWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation getAllTeamMembersWithHttpInfo
     *
     * Get all team members
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAllTeamMembers'] to see the possible values for this operation
     ...
     * @throws \sendx\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \sendx\model\RestRMember[]|\sendx\model\ErrorResponse|\sendx\model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllTeamMembersWithHttpInfo(string $contentType = self::contentTypes['getAllTeamMembers'][0])
    {
        $request = $this->getAllTeamMembersRequest($contentType);
    ...
    /**
     * Operation getAllTeamMembersAsync
     *
     * Get all team members
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAllTeamMembers'] to see the possible values for this operation
     ...
     */
    public function getAllTeamMembersAsync(string $contentType = self::contentTypes['getAllTeamMembers'][0])
    {
        return $this->getAllTeamMembersAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAllTeamMembersAsyncWithHttpInfo
     *
     * Get all team members
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAllTeamMembers'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllTeamMembersAsyncWithHttpInfo(string $contentType = self::contentTypes['getAllTeamMembers'][0])
    {
        $returnType = '\sendx\model\RestRMember[]';
        $request = $this->getAllTeamMembersRequest($contentType);
    ...
    /**
     * Create request for operation 'getAllTeamMembers'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAllTeamMembers'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function getAllTeamMembersRequest(string $contentType = self::contentTypes['getAllTeamMembers'][0])
    {


        $resourcePath = '/team/member';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \sendx\model\RestRMember|\sendx\model\ErrorResponse|\sendx\model\ErrorResponse
     */
    public function getTeamMember($identifier, string $contentType = self::contentTypes['getTeamMember'][0])
    {
        list($response) = $this->getTeamMemberWithHttpInfo($identifier, $contentType);
        return $response;
    }
     ...
     * @return array of \sendx\model\RestRMember|\sendx\model\ErrorResponse|\sendx\model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTeamMemberWithHttpInfo($identifier, string $contentType = self::contentTypes['getTeamMember'][0])
    {
        $request = $this->getTeamMemberRequest($identifier, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTeamMemberAsync($identifier, string $contentType = self::contentTypes['getTeamMember'][0])
    {
        return $this->getTeamMemberAsyncWithHttpInfo($identifier, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTeamMemberAsyncWithHttpInfo($identifier, string $contentType = self::contentTypes['getTeamMember'][0])
    {
        $returnType = '\sendx\model\RestRMember';
        $request = $this->getTeamMemberRequest($identifier, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTeamMemberRequest($identifier, string $contentType = self::contentTypes['getTeamMember'][0])
    {

        // verify the required parameter 'identifier' is set
        if ($identifier === null || (is_array($identifier) && count($identifier) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifier when calling getTeamMember'
            );
        }
        if (!preg_match("/^[a-z_]+_[a-zA-Z0-9]{22}$/", $identifier)) {
            throw new \InvalidArgumentException("invalid value for \"identifier\" when calling TeamMemberApi.getTeamMember, must conform to the pattern /^[a-z_]+_[a-zA-Z0-9]{22}$/.");
        }
        

        $resourcePath = '/team/member/{identifier}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
