...
class EventResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets event_id
     *
     * @param string|null $event_id Unique identifier for the created event.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Status of the event creation (e.g., 'success').
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Additional message about the event creation.
     *
     * @return self
     */
