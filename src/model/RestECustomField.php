...
/**
 * RestECustomField Class Doc Comment
 *
 * @category Class
 * @package  sendx
 * @author   OpenAPI Generator team
 ...
 */
class RestECustomField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestECustomField';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Custom field name (must be unique within team)
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param int $type Field data type.  **Values:** - `0` - Text (max 255 characters) - `1` - Number (integer or decimal) - `2` - Date (YYYY-MM-DD format) - `3` - Boolean (true/false) - `4` - Phone number (international format)
     *
     * @return self
     */
