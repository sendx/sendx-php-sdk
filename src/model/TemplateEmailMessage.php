...
/**
 * TemplateEmailMessage Class Doc Comment
 *
 * @category Class
 * @package  sendx
 * @author   OpenAPI Generator team
 ...
 */
class TemplateEmailMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplateEmailMessage';
    ...
    */
    ...
    public function setTo($to)
    {
        ...
        if ((count($to) < 1)) {
            throw new \InvalidArgumentException('invalid length for $to when calling TemplateEmailMessage., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets variables
     *
     * @param array<string,mixed>|null $variables Template variables for substitution
     *
     * @return self
     */
