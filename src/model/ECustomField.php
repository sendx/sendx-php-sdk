...
/**
 * ECustomField Class Doc Comment
 *
 * @category Class
 * @package  sendx
 * @author   OpenAPI Generator team
 ...
 */
class ECustomField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ECustomField';
    ...
    public const TYPE__0STRING = {0=string};
    public const TYPE__1NUMBER = {1=number};
    public const TYPE__2DATE = {2=date};
    public const TYPE__3BOOLEAN = {3=boolean};
    ...
    */
     ...
     * Sets type
     *
     * @param int|null $type Type of the custom field.
     *
     * @return self
     */
     ...
     * Sets shown
     *
     * @param bool|null $shown Whether the custom field is shown.
     *
     * @return self
     */
     ...
     * Sets is_shareable
     *
     * @param bool|null $is_shareable Whether the custom field is shareable.
     *
     * @return self
     */
    public function setIsShareable($is_shareable)
    {
        if (is_null($is_shareable)) {
            throw new \InvalidArgumentException('non-nullable is_shareable cannot be null');
        }
     ...
     * Sets description
     *
     * @param string|null $description Description of the custom field.
     *
     * @return self
     */
