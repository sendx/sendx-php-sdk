...
/**
 * RestRCustomField Class Doc Comment
 *
 * @category Class
 * @package  sendx
 * @author   OpenAPI Generator team
 ...
 */
class RestRCustomField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestRCustomField';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['id']) && !preg_match("/^field_[a-zA-Z0-9]{22}$/", $this->container['id'])) {
            $invalidProperties[] = "invalid value for 'id', must be conform to the pattern /^field_[a-zA-Z0-9]{22}$/.";
        }
     ...
     * Sets id
     *
     * @param string|null $id Unique field identifier with field_ prefix
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if ((!preg_match("/^field_[a-zA-Z0-9]{22}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling RestRCustomField., must conform to the pattern /^field_[a-zA-Z0-9]{22}$/.");
        }
     ...
     * Sets name
     *
     * @param string|null $name Custom field name
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param int|null $type Field data type.  **Values:** - `0` - Text (max 255 characters) - `1` - Number (integer or decimal) - `2` - Date (YYYY-MM-DD format) - `3` - Boolean (true/false) - `4` - Phone number (international format)
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Field description for documentation
     *
     * @return self
     */
