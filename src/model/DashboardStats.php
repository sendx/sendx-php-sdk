...
/**
 * DashboardStats Class Doc Comment
 *
 * @category Class
 * @package  sendx
 * @author   OpenAPI Generator team
 ...
 */
class DashboardStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DashboardStats';
    ...
    protected static $openAPITypes = [
        'last_email_campaign_stat' => '\sendx\model\LastSentCampaignStat',
    ...
    protected static array $openAPINullables = [
        'last_email_campaign_stat' => false,
        'newsletter_count' => false,
    ...
    protected static $attributeMap = [
        'last_email_campaign_stat' => 'lastEmailCampaignStat',
    ...
    protected static $setters = [
        'last_email_campaign_stat' => 'setLastEmailCampaignStat',
        'newsletter_count' => 'setNewsletterCount',
    ...
    protected static $getters = [
        'last_email_campaign_stat' => 'getLastEmailCampaignStat',
        'newsletter_count' => 'getNewsletterCount',
    ...
    {
        $this->setIfExists('last_email_campaign_stat', $data ?? [], null);
        $this->setIfExists('newsletter_count', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets last_email_campaign_stat
     *
     * @return \sendx\model\LastSentCampaignStat|null
     */
    public function getLastEmailCampaignStat()
    {
        return $this->container['last_email_campaign_stat'];
    }

    /**
     * Sets last_email_campaign_stat
     *
     * @param \sendx\model\LastSentCampaignStat|null $last_email_campaign_stat last_email_campaign_stat
     *
     * @return self
     */
    public function setLastEmailCampaignStat($last_email_campaign_stat)
    {
        if (is_null($last_email_campaign_stat)) {
            throw new \InvalidArgumentException('non-nullable last_email_campaign_stat cannot be null');
        }
        $this->container['last_email_campaign_stat'] = $last_email_campaign_stat;

        return $this;
    }

    /**
     * Gets newsletter_count
     *
     * @return int|null
     */
    public function getNewsletterCount()
    {
        return $this->container['newsletter_count'];
    }

    /**
     * Sets newsletter_count
     *
     * @param int|null $newsletter_count Number of newsletters sent.
     *
     * @return self
     */
    public function setNewsletterCount($newsletter_count)
    {
        if (is_null($newsletter_count)) {
            throw new \InvalidArgumentException('non-nullable newsletter_count cannot be null');
        }
        $this->container['newsletter_count'] = $newsletter_count;
     ...
     *
     * @param int|null $automation_count Number of automations set up.
     *
     * @return self
     */
