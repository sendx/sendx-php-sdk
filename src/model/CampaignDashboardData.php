...
/**
 * CampaignDashboardData Class Doc Comment
 *
 * @category Class
 * @package  sendx
 * @author   OpenAPI Generator team
 ...
 */
class CampaignDashboardData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignDashboardData';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Unique identifier for the campaign.
     *
     * @return self
     */
     ...
     * Sets sent_time
     *
     * @param \DateTime|null $sent_time The time the campaign was sent.
     *
     * @return self
     */
     ...
     *
     * @param string|null $campaign_screenshot_url URL to a screenshot of the campaign.
     *
     * @return self
     */
