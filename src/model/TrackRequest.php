...
class TrackRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('add_tags', $data ?? [], null);
        $this->setIfExists('remove_tags', $data ?? [], null);
    ...
    */
     ...
     * Sets add_tags
     *
     * @param string[]|null $add_tags Tags to add to contact
     *
     * @return self
     */
    ...
    {
        if (is_null($add_tags)) {
            throw new \InvalidArgumentException('non-nullable add_tags cannot be null');
        }
     ...
     * Sets remove_tags
     *
     * @param string[]|null $remove_tags Tags to remove from contact
     *
     * @return self
     */
    public function setRemoveTags($remove_tags)
    {
        if (is_null($remove_tags)) {
            throw new \InvalidArgumentException('non-nullable remove_tags cannot be null');
        }
