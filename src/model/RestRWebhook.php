...
/**
 * RestRWebhook Class Doc Comment
 *
 * @category Class
 * @package  sendx
 * @author   OpenAPI Generator team
 ...
 */
class RestRWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestRWebhook';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('dropped', $data ?? [], false);
        $this->setIfExists('bounced', $data ?? [], false);
        $this->setIfExists('marked_spam', $data ?? [], false);
        $this->setIfExists('clicked', $data ?? [], false);
        $this->setIfExists('opened', $data ?? [], false);
        $this->setIfExists('contact_created', $data ?? [], false);
    }
    ...
    */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Whether webhook is enabled
     *
     * @return self
     */
     ...
     * Sets unsubscribed
     *
     * @param bool|null $unsubscribed Trigger webhook when a contact unsubscribes
     *
     * @return self
     */
     ...
     * Sets dropped
     *
     * @param bool|null $dropped Trigger webhook when an email is dropped
     *
     * @return self
     */
     ...
     * Sets bounced
     *
     * @param bool|null $bounced Trigger webhook when an email bounces
     *
     * @return self
     */
     ...
     * Sets marked_spam
     *
     * @param bool|null $marked_spam Trigger webhook when an email is marked as spam
     *
     * @return self
     */
     ...
     * Sets clicked
     *
     * @param bool|null $clicked Trigger webhook when a link in the email is clicked
     *
     * @return self
     */
     ...
     * Sets opened
     *
     * @param bool|null $opened Trigger webhook when an email is opened
     *
     * @return self
     */
     ...
     *
     * @param bool|null $contact_created Trigger webhook when a new contact is created
     *
     * @return self
     */
    public function setContactCreated($contact_created)
    {
        if (is_null($contact_created)) {
            throw new \InvalidArgumentException('non-nullable contact_created cannot be null');
        }
