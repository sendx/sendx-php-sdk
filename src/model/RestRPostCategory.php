...
/**
 * RestRPostCategory Class Doc Comment
 *
 * @category Class
 * @package  sendx
 * @author   OpenAPI Generator team
 ...
 */
class RestRPostCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestRPostCategory';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Id for the post category
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name for the post category
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created Date and time when the post category was created
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated Date and time when the post category was last updated
     *
     * @return self
     */
