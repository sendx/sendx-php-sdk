...
class DeleteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('delete_contacts', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param bool|null $delete_contacts Indicates whether to delete associated contacts.
     *
     * @return self
     */
    public function setDeleteContacts($delete_contacts)
    {
        if (is_null($delete_contacts)) {
            throw new \InvalidArgumentException('non-nullable delete_contacts cannot be null');
        }
