...
/**
 * RestRTemplate Class Doc Comment
 *
 * @category Class
 * @package  sendx
 * @author   OpenAPI Generator team
 ...
 */
class RestRTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestRTemplate';
    ...
    public const EDITOR_TYPE_NUMBER_0 = 0;
    public const EDITOR_TYPE_NUMBER_1 = 1;
    public const EDITOR_TYPE_NUMBER_2 = 2;
    ...
    {
        return [
            self::EDITOR_TYPE_NUMBER_0,
            self::EDITOR_TYPE_NUMBER_1,
            self::EDITOR_TYPE_NUMBER_2,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['id']) && !preg_match("/^template_[a-zA-Z0-9]{22}$/", $this->container['id'])) {
            $invalidProperties[] = "invalid value for 'id', must be conform to the pattern /^template_[a-zA-Z0-9]{22}$/.";
        }
     ...
     * Sets id
     *
     * @param string|null $id Unique template identifier with template_ prefix
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if ((!preg_match("/^template_[a-zA-Z0-9]{22}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling RestRTemplate., must conform to the pattern /^template_[a-zA-Z0-9]{22}$/.");
        }
     ...
     * Sets subject
     *
     * @param string|null $subject Email subject line (if applicable)
     *
     * @return self
     */
     ...
     * Sets html_code
     *
     * @param string|null $html_code HTML content of the template
     *
     * @return self
     */
     ...
     * Sets template_code
     *
     * @param string|null $template_code Template code for visual editors (JSON structure)
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param int|null $type Template type.  **Values:** - `0` - Email template - `1` - Other types
     *
     * @return self
     */
     ...
     * Sets thumbnail
     *
     * @param string|null $thumbnail URL to template thumbnail image
     *
     * @return self
     */
     ...
     * Sets editor_type
     *
     * @param int|null $editor_type Editor type used to create the template.  **Values:** - `0` - PlainText - `1` - DragDrop - `2` - SendxEditor
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created Template creation timestamp
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated Template last update timestamp
     *
     * @return self
     */
