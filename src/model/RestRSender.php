 ...
 */
class RestRSender implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestRSender';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['id']) && !preg_match("/^sender_[a-zA-Z0-9]{22}$/", $this->container['id'])) {
            $invalidProperties[] = "invalid value for 'id', must be conform to the pattern /^sender_[a-zA-Z0-9]{22}$/.";
        }
     ...
     * Sets id
     *
     * @param string|null $id Unique sender identifier with sender_ prefix
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if ((!preg_match("/^sender_[a-zA-Z0-9]{22}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling RestRSender., must conform to the pattern /^sender_[a-zA-Z0-9]{22}$/.");
        }
     ...
     * Sets is_whitelisted
     *
     * @param bool|null $is_whitelisted Sender whitelist status
     *
     * @return self
     */
