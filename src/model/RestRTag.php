 ...
 */
class RestRTag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestRTag';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['id']) && !preg_match("/^tag_[a-zA-Z0-9]{22}$/", $this->container['id'])) {
            $invalidProperties[] = "invalid value for 'id', must be conform to the pattern /^tag_[a-zA-Z0-9]{22}$/.";
        }
     ...
     * Sets id
     *
     * @param string|null $id Unique tag identifier with tag_ prefix
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if ((!preg_match("/^tag_[a-zA-Z0-9]{22}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling RestRTag., must conform to the pattern /^tag_[a-zA-Z0-9]{22}$/.");
        }
     ...
     * Sets created
     *
     * @param \DateTime|null $created Tag creation timestamp
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated Tag last update timestamp
     *
     * @return self
     */
