 ...
 */
class RestETag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestETag';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Tag name (must be unique within team)
     *
     * @return self
     */
