...
class SenderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_whitelisted', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_whitelisted'] === null) {
            $invalidProperties[] = "'is_whitelisted' can't be null";
        }
     ...
     * Sets is_whitelisted
     *
     * @param bool $is_whitelisted Indicates if the sender is whitelisted
     *
     * @return self
     */
    public function setIsWhitelisted($is_whitelisted)
    {
        if (is_null($is_whitelisted)) {
            throw new \InvalidArgumentException('non-nullable is_whitelisted cannot be null');
        }
