...
/**
 * DeleteCampaign200Response Class Doc Comment
 *
 * @category Class
 * @package  sendx
 * @author   OpenAPI Generator team
 ...
 */
class DeleteCampaign200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deleteCampaign_200_response';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id ID of the deleted campaign
     *
     * @return self
     */
