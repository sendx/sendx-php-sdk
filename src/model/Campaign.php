...
class Campaign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const SCHEDULE_TYPE_NUMBER_0 = 0;
    public const SCHEDULE_TYPE_NUMBER_1 = 1;
    public const SCHEDULE_TYPE_NUMBER_2 = 2;
    public const SCHEDULE_TYPE_NUMBER_3 = 3;
    ...
    {
        return [
            self::SCHEDULE_TYPE_NUMBER_0,
            self::SCHEDULE_TYPE_NUMBER_1,
            self::SCHEDULE_TYPE_NUMBER_2,
            self::SCHEDULE_TYPE_NUMBER_3,
        ];
    }
    ...
    */
     ...
     *
     * @param string|null $schedule_condition Condition for scheduling the campaign, date at which the campaign should be sent
     *
     * @return self
     */
