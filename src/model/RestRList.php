 ...
 */
class RestRList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestRList';
    ...
    */
     ...
     * Sets type
     *
     * @param int|null $type List type.  **Values:** - `0` - Regular list (single opt-in) - `1` - Double opt-in list (requires email confirmation)
     *
     * @return self
     */
