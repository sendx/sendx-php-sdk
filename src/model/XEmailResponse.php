...
/**
 * XEmailResponse Class Doc Comment
 *
 * @category Class
 * @package  sendx
 * @author   OpenAPI Generator team
 ...
 */
class XEmailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'XEmailResponse';
    ...
    */
     ...
     * Sets submitted_at
     *
     * @param int|null $submitted_at Unix timestamp of submission
     *
     * @return self
     */
     ...
     * Sets error_code
     *
     * @param int|null $error_code Error code (0 = success)
     *
     * @return self
     */
