 ...
 */
class RestESender implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestESender';
    ...
    */
     ...
     * Sets email
     *
     * @param string $email Sender email address (must be verified)
     *
     * @return self
     */
